...
const { mintToken, COOKIE } = require("./login.js");
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const url = proto + "://" + req.headers.host + "/tracker.html";
    // Authenticate the headless session so middleware lets it through
    await page.setCookie({ name: COOKIE, value: mintToken(), url: proto + "://" + req.headers.host });
